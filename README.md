...
This will compare all the files in the `unzipped` directory and output the report of similarity to `moss_report/report.html`. Simply open this file in your web browser to see the results.
...
│   ├── concatenated_files
│   ├── report
│   └── report.html                         # Plagiarism report as generated by Moss
